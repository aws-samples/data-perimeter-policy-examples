...
**Description**: [CreateResourcePolicy](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_CreateResourcePolicy.html) allows you to apply a resource-based policy to grant access to a bot or bot alias. The service currently does not support RCPs.
...
**Description**: [CreateUploadUrl](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_CreateUploadUrl.html) returns an Amazon S3 presigned URL that users can use to upload the zip archive to a service-owned bucket when importing a bot or a bot locale. The presigned URL is created with the Amazon Lex V2 service principal.
...
**Description**: [DescribeExport](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_DescribeExport.html) returns an Amazon S3 presigned URL that users can use to download a bot or bot locale archive from a service-owned bucket. The presigned URL is created with the Amazon Lex V2 service principal.
...
**Description**: [UpdateResourcePolicy](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_UpdateResourcePolicy.html) allows you to apply a resource-based policy to grant access to a bot or bot alias. The service currently does not support RCPs.
